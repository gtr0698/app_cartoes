...
import 'package:flutter_application_aula3_cadastro/Data/cartao_entity.dart';
import 'package:flutter_application_aula3_cadastro/Data/cartao_sqlite_datasource.dart';
import 'package:flutter_application_aula3_cadastro/cadCartoes.dart';
import 'package:flutter_application_aula3_cadastro/listaSenhas.dart';
      ...
      floatingActionButton: FloatingActionButton(
          ...
          onPressed: () {
            Navigator.of(context)
                .push(MaterialPageRoute(builder: (context) => cadcartoes()));
          }),
    );
  }
}